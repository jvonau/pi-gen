...
if [ ! -f /opt/iiab/iiab-factory/flags/iiab-admin-console-complete ]; then
    ...
    ./install
    touch /etc/iiab/flags/iiab-admin-console-complete
    fi
EOF2
...
on_chroot << EOF3
    ...
    touch /etc/iiab/flags/kalite-zone-complete
    ...
    touch /etc/iiab/flags/kalite-en.zip-complete
    cd /opt/iiab/iiab-factory
    git checkout master
